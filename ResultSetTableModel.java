...
public class ResultSetTableModel extends AbstractTableModel {
   ...
   public ResultSetTableModel(String url, String username,
       String password, PreparedStatement passedstatement) throws SQLException {
      // connect to database
      connection = DriverManager.getConnection(url, username, password);

      // create Statement to query database
      statement = passedstatement;
   ...
   public void executeQuery(PreparedStatement passedstatement)
      ...
      switch (QueryType){
        case "Query": // specify query and execute it
        ...
        case "Update": statement.executeUpdate();
                      break;
